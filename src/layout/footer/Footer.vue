<template>
  <div class="footer">
    <div style=" position: absolute; top: 65px; width: 100%;">
      <ul>
        ...
        <li>
          ...
          <div
              style="width: 180px; margin-top: 20px;text-align: left; color: rgb(70,101,90); text-decoration: underline">
            <div style="margin-left: 20px; font-size: 16px;cursor: pointer" v-on:click="copyLink">复制分享链接</div>
            <div style="margin-left: 20px; font-size: 16px; margin-top: 10px; cursor: pointer" v-on:click="toQQShare">
              分享到QQ空间
            </div>
          </div>
        </li>
    ...
    <div
        style="position: absolute; bottom: 40px; width: 100%; color: #c49999; text-align: center; height: 20px; line-height: 20px">
      <img :src="beianImage"
           style="display: inline-block; vertical-align: center; position: absolute; top: -1px"/>
    ...
    <div
        style="position: absolute; bottom: 5px; width: 100%; color: #c49999; text-align: center; height: 20px; line-height: 20px">
...
export default {
  ...
  data() {
    return {
      beianImage: require('../../../public/image/beian.png'),
      imgUrl: require('../../../public/image/template.png'),
